 ...
 * <p>
 * An <code>ObjectiveCard</code> is a type of card that players can use to achieve certain
...
public abstract sealed class ObjectiveCard implements CardIdentity
     ...
     * <p>
     * This constructor takes a <code>Builder</code> object as a parameter. It uses the
     * <code>Builder</code> to set the points and id fields of the <code>ObjectiveCard</code>.
     * <p>
     * The points and id fields are final, meaning they cannot be changed after the
     * <code>ObjectiveCard</code> is created.
     * <p>
     * This ensures the immutability of <code>ObjectiveCard</code> objects.
     *
     * @param builder The <code>Builder</code> object from which to get the points and id for the
     *                <code>ObjectiveCard</code>.
     */
     ...
     * <p>
     * This method returns the points of the <code>ObjectiveCard</code>. The points represent the
     * score a player can achieve by fulfilling the objective of the card.
     * <p>
     ...
     * <p>
     * This method takes an <code>Item</code> as a parameter, which can be either a
     * <code>Color</code> or a
     * <code>Symbol</code>. It then checks the requirements of the <code>ObjectiveCard</code> for
     * that item.
     * <p>
     * If the item is a Color, it checks the color requirements of the ObjectiveCard. If the item is
     * a Symbol, it checks the symbol requirements of the ObjectiveCard.
     * <p>
     * The method returns the quantity of the item required by the ObjectiveCard.
     *
     * @param item The item to check the requirements for. This can be either a <code>Color</code>
     *             or a
     *             <code>Symbol</code>.
     * @return The quantity of the item required by the <code>ObjectiveCard</code>, or null if the
     ...
     * <p>
     * This method returns an <code>Map</code> where the keys are <code>Colors</code> and the values
     * are
     * <code>Integers</code>.
     * <p>
     * Each entry in the map represents a requirement for a specific color, and the associated
     * integer is the quantity of that color required.
     * <p>
     * The color requirements are set when the card is created and cannot be changed afterward.
     * <p>
     * Note: the returned <code>Map</code> is implemented with
     * {@link com.google.common.collect.ImmutableMap ImmutableMap}.
     *
     ...
     * <p>
     * This method returns an <code>Map</code> where the keys are <code>Symbols</code> and the
     * values are
     * <code>Integers</code>.
     * <p>
     * Each entry in the map represents a requirement for a specific symbol, and the associated
     * integer is the quantity of that symbol required.
     * <p>
     ...
     * The
     * <code>ObjectiveCardType</code> is an enum that represents the type of the
     * <code>ObjectiveCard</code>.
     * <p>
     * The type of the <code>ObjectiveCard</code> is set when the card is created and cannot be
     * changed afterward.
     *
    ...
    /**
     * This is an abstract <code>Builder</code> class for creating instances of
     * <code>ObjectiveCard</code>.
     * <p>
     * The <code>Builder</code> follows the "Builder" design pattern. It provides a way to construct
     * a complex object step by step. This <code>Builder</code> is abstract and is meant to be
     * subclassed by concrete
     * <code>Builder</code> classes for specific types of <code>ObjectiveCard</code>.
     * <p>
     * The <code>Builder</code> takes the id and points of the <code>ObjectiveCard</code> as
     * parameters in its constructor. These values are then used to set the corresponding fields of
     * the <code>ObjectiveCard</code> when the <code>build</code> method is called.
     * <p>
     * The <code>build</code> method is abstract and must be implemented by subclasses of this
     * <code>Builder</code>. It is responsible for creating the <code>ObjectiveCard</code> and
     * ensuring that it is in a valid state.
     * <p>
     * The type parameter <code>T</code> extends <code>ObjectiveCard</code>, meaning the
     * <code>Builder</code> can be used to create any type of <code>ObjectiveCard</code>.
     *
     * @param <T> The specific type of <code>ObjectiveCard</code> that this <code>Builder</code>
     *            builds.
     */
    public static abstract class Builder<T extends ObjectiveCard> {
         ...
         * These values are then used to set the corresponding fields of the
         * <code>ObjectiveCard</code> when the <code>build</code> method is called.
         * <p>
         * The points must be greater than 0, otherwise an <code>IllegalArgumentException</code> is
         * thrown.
         *
         ...
         * It uses the id and points provided to the <code>Builder</code>'s constructor to set the
         * corresponding fields of the <code>ObjectiveCard</code>.
         * <p>
         * This method is abstract and must be implemented by subclasses of this
         * <code>Builder</code>. The specific implementation will depend on the specific type of
         * <code>ObjectiveCard</code> being built.
         * <p>
         * Note: This method can throw an <code>IllegalCardBuildException</code> if the
         * <code>ObjectiveCard</code> cannot be built in a valid state.
         *
         * @return An instance of <code>T</code>, which extends <code>ObjectiveCard</code>.
         * @throws IllegalCardBuildException if the <code>ObjectiveCard</code> cannot be built in a
         *                                   valid state.
         */
