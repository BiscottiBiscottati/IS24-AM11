...
/**
 * The UI uses this interface to get the connector to send commands to the server and to close the
 * connection. Each network implementation will provide an implementation of this interface.
 *
