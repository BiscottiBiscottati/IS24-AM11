...
public class TimingFactoryTest {
    ...
    void testTiming() {
        ...
        System.out.println("average timing Resource = " + formatter.format(getNumber(end, start)) + " ms");
        ...
        System.out.println("average timing Starter = " + formatter.format(getNumber(end, start)) + " ms");
        ...
        System.out.println("average timing Gold = " + formatter.format(getNumber(end, start)) + " ms");
        ...
        System.out.println("average timing Objective = " + formatter.format(getNumber(end, start)) + " ms");
